...
function isSellerRole(role) {
    return role === 'seller' || role === 'ROLE_SELLER' || role === 'SELLER';
}
...
function Profile({ onBack }) {
    ...
    useEffect(() => {
        ...
        if (isSeller) {
            ...
            async function loadSeller() {
                ...
                if (storedSellerId) {
                    seller = await sellerService.getById(storedSellerId).catch(() => null);
                }
                ...
                if (!seller) {
                    ...
                    seller = list.find((s) => s.fullname === fullName) || null;
                }

                if (!seller && user.id) {
                    seller = await sellerService.getById(user.id).catch(() => null);
                }
        ...
        customerService.getById(user.id).then((data) => {
    ...
    }, [user?.id, user?.email, user?.sellerId, user?.firstName, user?.lastName, updateUser, isSeller]);
                        ...
                        <>
                            <div className="profile__fields">
                                <div className="profile__field">
                                    ...
                                    <span className="profile__field-value">{user?.firstName || '-'}</span>
                                </div>
                                <div className="profile__field">
                                    <span className="profile__field-label">Apellido</span>
                                    <span className="profile__field-value">{user?.lastName || '-'}</span>
                                </div>
                                <div className="profile__field">
                                ...
                                <div className="profile__field">
                                    <span className="profile__field-label">Telefono</span>
                                    <span className="profile__field-value">{user?.phoneNumber || '-'}</span>
                                </div>
                                <div className="profile__field">
                                    <span className="profile__field-label">Direccion</span>
                                    <span className="profile__field-value">{user?.address || '-'}</span>
                                </div>
                                <div className="profile__field">
                                    <span className="profile__field-label">Ciudad</span>
                                    <span className="profile__field-value">{user?.city || '-'}</span>
                                </div>
                                <div className="profile__field">
                                    <span className="profile__field-label">Departamento</span>
                                    <span className="profile__field-value">{user?.department || '-'}</span>
                                </div>
                                <div className="profile__field">
                                    <span className="profile__field-label">Tipo de Documento</span>
                                    <span className="profile__field-value">{user?.dniType || '-'}</span>
                                </div>
                                <div className="profile__field">
                                    <span className="profile__field-label">Numero de Documento</span>
                                    <span className="profile__field-value">{user?.dniNumber || '-'}</span>
                                </div>
                            </div>
